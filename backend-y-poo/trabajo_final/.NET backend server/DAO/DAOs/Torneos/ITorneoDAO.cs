...
namespace DAO.DAOs.Torneos
{
    public interface ITorneoDAO
    {
        ...
        public Task<IEnumerable<Torneo>> BuscarTorneosInscriptos(int id_jugador);
        ...
        public Task<IEnumerable<Jugador_Inscripto>> BuscarJugadorInscripto(int id_jugador, IEnumerable<Torneo> torneos);
